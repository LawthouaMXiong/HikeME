...
async function checkWeather(state) {
    ...
    if (data.weather[0].main == "Clouds") {
        weatherIcon.src = "./HikeME/assets/images/weatherImages/Clouds.png"
    }
    else if (data.weather[0].main == "Clear") {
        weatherIcon.src = "./HikeME/assets/images/weatherImages/Clear.png"
    }
    else if (data.weather[0].main == "Rain") {
        weatherIcon.src = "./HikeME/assets/images/weatherImages/Rain.png"
    }
    else if (data.weather[0].main == "Drizzle") {
        weatherIcon.src = "./HikeME/assets/images/weatherImages/Drizzle.png"
    }
    else if (data.weather[0].main == "Atomosphere") {
        weatherIcon.src = "./HikeME/assets/images/weatherImages/Atomosphere.png"
    }
    else if (data.weather[0].main == "Snow") {
        weatherIcon.src = "./HikeME/assets/images/weatherImages/Snow.png"
    }
    else if (data.weather[0].main == "Thunderstorm") {
        weatherIcon.src = "./HikeME/assets/images/weatherImages/Thunderstorm.png"
    }
